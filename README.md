...
| Delivery and reliability | Docker Compose, Caddy TLS, health/readiness endpoints, backups, CI, approval-gated manual CD, API tests, and 28 Playwright browser workflows |
