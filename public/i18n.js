...
Object.assign(translations,{
  'Korisnički nalozi':'User accounts','Zaštita naloga':'Account security','Promenite privremenu lozinku':'Change your temporary password','Pre nastavka postavite ličnu lozinku od najmanje 12 znakova.':'Set a personal password of at least 12 characters before continuing.','Trenutna lozinka':'Current password','Nova lozinka':'New password','Potvrdite novu lozinku':'Confirm new password','Sačuvaj novu lozinku':'Save new password','Kreiraj nalog':'Create account','Privremena lozinka se prikazuje samo jednom i korisnik je menja pri prvoj prijavi.':'The temporary password is shown once and must be changed at first sign-in.','Ime za prikaz':'Display name','Uloga':'Role','Privremena lozinka':'Temporary password','Opciono — generiši automatski':'Optional — generate automatically','Status':'Status','Poslednja prijava':'Last sign-in','Akcije':'Actions','Aktivan':'Active','Neaktivan':'Inactive','Deaktiviraj':'Deactivate','Aktiviraj':'Activate','Resetuj lozinku':'Reset password','promena lozinke obavezna':'password change required','Nema korisničkih naloga.':'No user accounts.','Privremena lozinka za':'Temporary password for','Sačuvajte je sada; više neće biti prikazana.':'Save it now; it will not be shown again.','Nove lozinke se ne podudaraju.':'The new passwords do not match.',
  'Current password is incorrect.':'Trenutna lozinka nije ispravna.','New password must contain between 12 and 128 characters.':'Nova lozinka mora imati između 12 i 128 znakova.','New password must be different from the current password.':'Nova lozinka mora biti različita od trenutne.','You must change your temporary password before continuing.':'Morate promeniti privremenu lozinku pre nastavka.','Username must contain 3-40 lowercase letters, numbers, dots, underscores or hyphens.':'Korisničko ime mora imati 3–40 malih slova, cifara, tačaka, donjih crta ili crtica.','Display name must contain between 2 and 80 characters.':'Ime za prikaz mora imati između 2 i 80 znakova.','Select a supported role.':'Izaberite podržanu ulogu.','That username already exists.':'To korisničko ime već postoji.','Temporary password must contain between 12 and 128 characters.':'Privremena lozinka mora imati između 12 i 128 znakova.','Active status must be a boolean.':'Status aktivnosti nije ispravan.','You cannot deactivate your own account.':'Ne možete deaktivirati sopstveni nalog.','You cannot remove your own administrator role.':'Ne možete ukloniti sopstvenu administratorsku ulogu.','User was not found.':'Korisnički nalog nije pronađen.'
});
Object.assign(translations,{
  'Kotva — detalji polise':'Kotva — policy details','← Nazad na korisnike':'← Back to clients','Učitavanje detalja polise…':'Loading policy details…','Podaci o polisi':'Policy details','Osiguranik':'Policyholder','Akcije na polisi':'Policy actions','Sačuvaj statuse':'Save statuses','Istorija polise':'Policy history','Detalji polise':'Policy details','ugovorena vrednost':'contracted value','Naplaćeno':'Collected','evidentirane uplate':'recorded payments','Preostalo':'Outstanding','za naplatu':'to collect','bezbedno sačuvani':'securely stored','Period važenja':'Coverage period','Prodajni agent':'Selling agent','Vozilo':'Vehicle','ID korisnika':'Client ID','Nema evidentirane istorije.':'No history recorded.','Polisa kreirana':'Policy created','Status polise promenjen':'Policy status changed','Broker potvrdio vozilo':'Broker confirmed vehicle','Uplata evidentirana':'Payment recorded','Dokument dodat':'Document uploaded','Status polise je ažuriran.':'Policy status updated.'
});
Object.assign(translations,{
...
Object.assign(translations,{
  'Sačuvaj promene':'Save changes','Promene na polisi su sačuvane.':'Policy changes saved.'
});
...
Object.assign(translations,{'Izveštaj po donosiocu':'Introducer report','Polise koje je doneo zaposleni':'Policies brought by an employee','Izaberite donosioca i preuzmite zasebnu Excel listu njegovih polisa.':'Select an introducer and download their separate Excel policy list.','Preuzmi spisak polisa':'Download policy list','Izaberite donosioca.':'Select an introducer.'});
Object.assign(translations,{'Broj polise osiguravača':'Insurer policy number','Unesite broj sa polise':'Enter the number on the policy','Brza pretraga':'Quick search','Pronađi polisu po broju':'Find a policy by number','Pretraži broj koji je dodelila osiguravajuća kuća ili Kotvin interni broj polise.':'Search the insurer-issued number or Kotva’s internal policy number.','Broj polise':'Policy number','Unesite ceo broj ili njegov deo':'Enter the full number or part of it','Pronađi polisu':'Find policy','Pretraga u toku...':'Searching...','Kotvin broj':'Kotva number','Arhivirana verzija':'Archived version','Otvori polisu':'Open policy','Nema polisa za uneti broj.':'No policies match that number.','Prikazano prvih 20 rezultata.':'Showing the first 20 results.','Unesite najmanje 2, a najviše 80 znakova broja polise.':'Enter 2 to 80 characters of the policy number.','Broj polise osiguravača može imati najviše 80 znakova i ne sme sadržati kontrolne znakove.':'The insurer policy number must be at most 80 characters and contain no control characters.'});
initializeLanguage();
