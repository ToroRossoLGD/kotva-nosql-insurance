const $=s=>document.querySelector(s),charts={},colors=['#ff6b35','#112f4a','#39a88e','#f2b84b','#7b6ee6','#e85d75'];let claimStatuses=[];
...
async function enterApplication(user){applyPermissions(user);$('#sale-date').valueAsDate=new Date();setDefaultPolicyDates();await Promise.all([options(),refresh(),loadLoginAttempts()])}
